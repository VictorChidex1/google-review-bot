...
export default function DocsPage({ isPublic = false }: DocsPageProps) {
  const content = (
    <div
      className={`bg-slate-50 font-sans text-slate-900 selection:bg-emerald-100 selection:text-emerald-900 ${
            ...
            <div className="prose prose-slate prose-lg max-w-none">
              <section id="getting-started" className="scroll-mt-32">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Welcome to VeraVox AI! We help you respond to Google Reviews
                  10x faster.
                </p>
              ...
              >
                ...
                <ul className="grid sm:grid-cols-2 gap-4 not-prose my-4">
                  ...
                  <li className="bg-white p-3 rounded-lg border border-slate-200 text-sm">
                    <span className="font-bold block mb-1">3. Generate</span>Get
                    3 unique options.
                  </li>
                  <li className="bg-white p-3 rounded-lg border border-slate-200 text-sm">
