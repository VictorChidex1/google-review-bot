  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (error.code === "permission-denied") {
        alert("Permission Denied: Ensure Firestore Rules are deployed.");
      } else if (error.code === "auth/requires-recent-login") {
        alert(
          "Security Check: Please sign out and sign in again before deletion."
        );
      } else {
              ...
              <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                ...
                <div className="bg-slate-50 rounded-xl p-6 border border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                  ...
                  <div className="flex gap-3">
                    <button className="px-4 py-2 bg-white border border-slate-200 text-slate-600 font-bold rounded-lg hover:border-slate-300 transition-colors text-sm">
                      Cancel
                    </button>
                    <button className="px-4 py-2 bg-slate-900 text-white font-bold rounded-lg hover:bg-slate-800 transition-colors text-sm">
                      Upgrade Plan
                    </button>
                  </div>
                </div>
